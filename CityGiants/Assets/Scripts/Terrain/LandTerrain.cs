...
public class LandTerrain {
    ...
    public LandTerrain(Sprite[] aSprite, Dictionary<ResourceList,int> aResources, string aName, MoveRange aRange, ExpeditionAvailability aAvail)
    {
        this.sprSprite = aSprite;
        this.dResources = aResources;
        this.sName = aName;
        this.enRange = aRange;
        this.enAvail = aAvail;
    }
